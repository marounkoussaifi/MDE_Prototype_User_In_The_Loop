...
public class TraitementDecision implements ITraitementDecision {
    ...
    public TraitementDecision(OCService service, ICommunication communication, ISuicideService suicideService, ReferenceAgent referenceAgent, IBinding binding) {
